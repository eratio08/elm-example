...
var $author$project$Main$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{currentUser: $elm$core$Maybe$Nothing, error: $elm$core$Maybe$Nothing},
...
var $author$project$Main$backendUrl = 'http://localhost:1337';
			...
			if (msg.a.$ === 'Err') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentUser: $elm$core$Maybe$Just(user)
						}),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			return _Utils_Tuple2(model, $author$project$Main$getUser);
		}
	});
var $author$project$Main$LoadUser = {$: 'LoadUser'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$LoadUser)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Load User')
					]))
			]));
};
